...
for(let k of Object.keys(isoCountries)){
    let val = isoCountries[k];
    nameToiso[val] = k;
}

export const getIsoCode: (country: string) => string | null = (country: string){
    if(!(country in nameToiso))
        return null;
    if(country in isoCountries) //already iso code
        return country;
    return nameToiso[country];
}
export const getCountry: (isoCode: string) => string | null = (isoCode: string)=>{
